from typing import LiteralString, Type, Dict, Union, Optional
...
class StateMachine:
    ...
    def get_user_state(self, user: LiteralString) -> Optional[Type[UserState_gpt_excel]]:
    ...
    def set_user_state(self, state_name: LiteralString, user: LiteralString)\
    ...
    def add_state(self, state_name: LiteralString):
    ...
    def delete_state(self, state_name: LiteralString) -> IdentitySet:
        state = self.get_state(state_name=state_name)
        self.session.delete(state)
        self.session.commit()
        return self.session.new

    def get_state(self, state_name: LiteralString) -> Optional[Type[States_gpt_excel]]:
    ...
    def _update_existing_user(self, user: Type[UserState_gpt_excel], state_name: LiteralString) -> IdentitySet:
    ...
    def _create_new_user_and_set_state(self, state_name: LiteralString, user: LiteralString) -> IdentitySet:
